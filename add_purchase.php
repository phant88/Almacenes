...
include_once("init.php");
	if(isset($_POST['supplier']) and isset($_POST['stock_name'])){
					...
					if($validated_data === false) {
							...
							$stockid=mysqli_real_escape_string($db->getConnection(),$_POST['stockid']);
						
							$bill_no =mysqli_real_escape_string($db->getConnection(),$_POST['bill_no']);
							$supplier=mysqli_real_escape_string($db->getConnection(),$_POST['supplier']);
							$address=mysqli_real_escape_string($db->getConnection(),$_POST['address']);
							$contact=mysqli_real_escape_string($db->getConnection(),$_POST['contact']);
							...
							$due=mysqli_real_escape_string($db->getConnection(),$_POST['duedate']);
							...
							$mode=mysqli_real_escape_string($db->getConnection(),$_POST['mode']);
														...
														<div class="mytable_row ">
															<table class="form"  border="0" cellspacing="0" cellpadding="0">
																<tr>
																	...
																	<td><span class="man">*</span>Nro Doc:</td>
