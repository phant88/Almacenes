...
<body>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			$sell=trim(mysqli_real_escape_string($db->getConnection(),$_POST['sell']));
			$cost=trim(mysqli_real_escape_string($db->getConnection(),$_POST['cost']));
			$Category=trim(mysqli_real_escape_string($db->getConnection(),$_POST['Category']));
			$date=trim(mysqli_real_escape_string($db->getConnection(),$_POST['date']));
			$supplier=trim(mysqli_real_escape_string($db->getConnection(),$_POST['supplier']));
